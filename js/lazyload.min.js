...
!(function (t) {
  ...
  function c(t, e) {
    return (
      (e._$container == o
        ? ("innerHeight" in n ? n.innerHeight : o.height()) + o.scrollTop()
      ...
      if (!((_.width() <= 0 && _.height() <= 0) || "none" === _.css("display")))
        if (a.vertical_only)
            ...
            return (
              (a._$container == o
                ? t.fn.scrollLeft
                  ? o.scrollLeft()
                  : n.pageXOffset
                : a._$container.offset().left) >=
              e.offset().left + a.threshold + e.width()
            );
          })(_, a)
        );
        else if (
          ...
          (function (e, a) {
            return (
              (a._$container == o
                ? o.width() + (t.fn.scrollLeft ? o.scrollLeft() : n.pageXOffset)
                : a._$container.offset().left + a._$container.width()) <=
        ...
        return (
          ...
          s.each(function (a, r) {
            var n = this,
              ...
              h = o.is("img");
            if (o.data("_lazyload_loadStarted") || l == _)
              return o.data("_lazyload_loadStarted", !0), void (s = d(s));
            o.data("_lazyload_loadStarted", !1),
              ...
              o.one("_lazyload_appear", function () {
                ...
                function l() {
                  a && o.hide(),
                    h
                      ? (u && o.attr("srcset", u), _ && o.attr("src", _))
                      : o.css("background-image", 'url("' + _ + '")'),
                ...
                o.data("_lazyload_loadStarted") ||
                  ((a =
                    "show" != e.effect &&
                    t.fn[e.effect] &&
                    (!e.effect_params || (r && 0 == e.effect_params.length))),
